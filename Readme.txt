...
web文件夹:Web应用的相关文件，分为Administrator(管理者)、Student(考生)、CSS(样式)、ExcelFile(Excel
文件存放)、Images(图片文件存放)、WEB-INF(服务器相关文件存放)文件夹和两个登录的.jsp文件。
...
MySQL数据库连接：mysql-connector-java-5.1.10-bin
